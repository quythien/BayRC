...
grid.arrange(grobs = qq_ordered,
             ...
             top = "Normality Check (QQ Plots) - Baboon LUN / PUT / SUN - Top Rhythmic Genes")
dev.off()
cat("Saved:", basename(qq_file), "\n")

rt_file <- file.path(outdir, "Cosinor_ResidTOD_Baboon_LUN_PUT_SUN.pdf")
